...
## **_What attributes would you take into account for each class in the project?_**
 ...
 - **_For the exam (Examen) class:_**
   ...
   - **_Date ((Date the exam was taken))._**
...
**_3.-_** **_Agregar Control a un Paciente:_** **_El veterinario desea agregar un control a un paciente que puede tener ficha o no. Para ello, en el caso de que tenga, se realiza el caso de uso Buscar Ficha Veterinaria. En caso de no tener se
